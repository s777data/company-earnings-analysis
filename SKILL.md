...
3. KPI immediately below Financial Highlights: all 16 importance-ordered company-specific operating measures with current-quarter value, prior-year-quarter value, analyst view, `IR|SEC|IR/SEC` source, and importance. Every Tier 1 row is retained, followed by all lower tiers in importance order.
...
- KPI — sixteen readable source-backed operating scorecards in two A4-width rows of eight
- Key Ratios
- Valuation
