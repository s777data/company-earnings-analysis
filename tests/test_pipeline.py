...
class InteractiveDashboardTests(unittest.TestCase):
    ...
    def test_reference_scorecard_structure_is_shared_and_data_driven(self):
        ...
        self.assertIn("grid-template-rows: 6.2mm 2.8mm .2mm 1.7mm 5.8mm", css)
        self.assertIn(".kpi-grid--single .kpi-card", css)
        self.assertIn("height: 28.5mm", css)
        self.assertIn(".kpi-grid--double .kpi-card", css)
        ...
        self.assertIn("font-size: 6.375px", css)
        self.assertIn(".kpi-latest strong.kpi-value--long", css)
        self.assertIn("font-size: 4.5px", css)
        self.assertIn(".kpi-prior strong.kpi-value--long", css)
        self.assertIn("font-size: 3.05px", css)
