...
- Keep the report within one A4 portrait page. Each KPI row uses the same card height as Income Statement Highlights; Key Ratios uses half-height wrapping cards; Key Risks and Investment Thesis use half-height two-column lists; and Grade Reasoning uses explicit wrapping with enough height to display all rows. Key Channels & Segments and Strategic Pillars retain their previously validated half-height cards.
